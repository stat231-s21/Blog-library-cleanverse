...
![The Shift in Number of Vaccines Delivered Across the United States ](https://raw.githubusercontent.com/stat231-s21/Blog-library-cleanverse/main/kriti/usa_vaccine_number_all_states.gif)
As we can see here, California, Texas, and Florida stand out as the states that administer a larger amount of vaccines per day, as they get shaded a darker blue much faster than the other states do. If we want to see which states  Additionally, looking at the map regionally, part of the mid-west and north-west, especially North Dakota and Wyoming, along with Maine and West Virginia have the lowest number of vaccinations given on a daily basis. 
