...
You can embed a gif like this.  (You can also embed a Shiny app using the `iframe` tag.)

<iframe src="https://giphy.com/embed/XHVmD4RyXgSjd8aUMb" width="480" height="360" frameBorder="0" class="giphy-embed" allowFullScreen></iframe> <p> <a href="https://giphy.com/search/pugs">via GIPHY</a> </p>
