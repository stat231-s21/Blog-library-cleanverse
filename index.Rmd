...
The other benefit of creating these maps was that it allowed me to look at regional patterns. I could see that the South, in addition to some Great Plains states, had very low levels on both maps. Now, those are historically Repbulican regions. That inspired me to go ahead with my political research. 
...
Given this research, there's a clear motive to understanding what's causing these failures in adminsitration, as we can then better combat them and move towards vaccination. 
...
![Cumulative Number of Vaccine Doses Delivered by State as a Percent of Population ](https://raw.githubusercontent.com/stat231-s21/Blog-library-cleanverse/main/kriti/usapercentfinal3.gif)
