...
```{r}
kv_vaccine_states <- read_csv("kriti/us-daily-covid-vaccine-doses-administeredpopstate.csv")
...
animate(anim_map, nframes = 2*length(unique(usa_vaccine_states$Day))
        , renderer = gifski_renderer("kriti/ma_example.gif"))
